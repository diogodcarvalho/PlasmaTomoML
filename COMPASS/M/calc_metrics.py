...
save_path = './Results/'
# all files generated by this script will be stored in the following directory
if not os.path.exists(save_path + 'METRICS/'):
        print '\nCreating directory ', save_path + 'METRICS/'
...
print 'Creating :', save_path + 'METRICS/' + 'metrics.csv'

with open(save_path + 'METRICS/' + 'metrics.csv', 'w') as csvfile:
