...
In this case the training/validation/test set belong to the same group of *.mat files with the same geometry
...
In this case the training/validation set belong to a group of reconstructions, the tomograms in the test (if it exists) were obtained from the geometry we intend to apply the NN
