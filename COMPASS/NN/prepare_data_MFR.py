...
f,g,ef,fv,t,chi2,pulse,SXRA,SXRB,SXRF = bib_data.get_tomo_MFR(data_directory, subsampling = 1,  flatten = False)

# enforce detector shape to be always (bib_geom.N_LOS_MAX,)
f = np.pad(f,((0,0),(0,bib_geom.N_LOS_MAX-f.shape[1])),'constant', constant_values= 0)
ef = np.pad(ef,((0,0),(0,bib_geom.N_LOS_MAX-f.shape[1])),'constant', constant_values= 0)
fv = np.pad(fv,((0,0),(0,bib_geom.N_LOS_MAX-f.shape[1])),'constant', constant_values= 0)
